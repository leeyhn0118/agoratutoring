...
import SVG6 from 'src/assets/svg/human.svg';
...
export const humanIcon = styled(SVG6)`
  width: 30px;
  height: 30px;
  padding: 5px;
  position: absolute;
  top: 16%;
  left: 5%;
  filter: invert(100%) sepia(0%) saturate(0%) hue-rotate(0deg) brightness(50%) contrast(0);
`;
